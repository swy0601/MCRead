...
# confusion_matrix用来查看TN FP FN TP
...
print("Vocabulary size:", model.vocab.get_vocab_size())
print("Index to token vocabulary:", model.vocab.get_index_to_token_vocabulary(namespace="tokens"))
...
print('*'*80)
print(result_dict)
print(confusion_matrix(all_ref,all_pred))
saved_config = {
